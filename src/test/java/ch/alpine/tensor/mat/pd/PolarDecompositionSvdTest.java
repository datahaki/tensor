...
class PolarDecompositionSvdTest {
  ...
  void testStrang() throws ClassNotFoundException, IOException {
    ...
    OrthogonalMatrixQ.INSTANCE.require(q);
  ...
  void testTransposeUsingSvd() {
    ...
    OrthogonalMatrixQ.INSTANCE.require(Transpose.of(result));
  ...
  void testAlternatives(int d) {
    ...
    OrthogonalMatrixQ.INSTANCE.require(u1);
    OrthogonalMatrixQ.INSTANCE.require(Transpose.of(u1));
    UnitaryMatrixQ.INSTANCE.require(u1);
  }
}
