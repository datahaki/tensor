...
public class SingularValueDecompositionTest extends TestCase {
  public void testSvd1() {
    ...
    SingularValueDecomposition svd = TestHelper.specialOps(mat);
  ...
  public void testSvd2() {
    ...
    TestHelper.specialOps(svd.getV());
    TestHelper.specialOps(Transpose.of(PseudoInverse.of(svd)));
    TestHelper.specialOps(Transpose.of(NullSpace.of(svd)));
  }
  ...
  public void testSvdR1() {
    ...
    SingularValueDecomposition svd = TestHelper.specialOps(matrix);
  ...
  public void testSo3() {
    ...
    SingularValueDecomposition svd = TestHelper.specialOps(sk);
    assertEquals(MatrixRank.of(svd), 2);
  }

  public void testFullConstant() {
    Tensor d = Tensors.matrix((i, j) -> RealScalar.of(1e-10), 10, 10);
    SingularValueDecomposition svd = TestHelper.specialOps(d);
