...
public class SingularValueDecompositionTest extends TestCase {
  public void testSvd1() {
    ...
    assertEquals(MatrixRankTest.of(svd), 5);
  }
  ...
  public void testSvd2() {
    ...
    assertEquals(MatrixRankTest.of(svd), 2);
  ...
  public void testSvd3() {
    ...
    assertEquals(MatrixRankTest.of(svd), 3);
    TestHelper.svd(svd.getU());
    TestHelper.svd(svd.getV());
    TestHelper.svd(Transpose.of(PseudoInverse.of(svd)));
    TestHelper.svd(Transpose.of(NullSpace.of(svd)));
  ...
  public void testSvd4() {
    ...
    assertEquals(MatrixRankTest.of(svd), n);
  ...
  public void testSvdR1() {
    ...
    if (MatrixRankTest.of(svd) == n) // 1e-12 failed in the past
  ...
  public void testEye() {
    assertEquals(MatrixRankTest.usingSvd(IdentityMatrix.of(10)), 10);
    assertEquals(MatrixRankTest.usingSvd(DiagonalMatrix.with(Tensors.vector(1, 1, 1, 1, 0, 0))), 4);
  }
