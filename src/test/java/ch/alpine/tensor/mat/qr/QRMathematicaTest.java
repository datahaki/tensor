...
class QRMathematicaTest {
  ...
  void testSkinny() {
    ...
    QRMathematica.wrap(QRDecompositionWrap.of(matrix));
  ...
  void testSimple() {
    ...
    QRDecomposition qr = QRDecompositionWrap.of(a);
  ...
  void testDet() {
    ...
    for (int n = 3; n < 6; ++n) {
      ...
      QRDecomposition qrDecomposition = QRMathematica.wrap(QRDecompositionWrap.of(matrix));
