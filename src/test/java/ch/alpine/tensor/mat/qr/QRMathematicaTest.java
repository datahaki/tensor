...
public class QRMathematicaTest extends TestCase {
  public void testSkinny() {
    ...
    qrDecompositionImpl.getQTranspose();
  ...
  public void testSimple() {
    ...
    assertEquals(Dimensions.of(qrDecomposition.getQTranspose()), Arrays.asList(3, 4));
    Tensor r = qrDecomposition.getR();
    Tensor q = qrDecomposition.getQ();
    Tolerance.CHOP.requireClose(q.dot(r), a);
    Tolerance.CHOP.requireClose(ConjugateTranspose.of(q), qrDecomposition.getQTranspose());
  ...
  public void testRectangularBigSmall() {
    ...
    for (int m = 3; m < 6; ++m) {
      ...
      assertEquals(Dimensions.of(qrDecomposition.getQTranspose()), Arrays.asList(Math.min(n, m), n));
