...
public class CholeskyDecompositionTest extends TestCase {
  static CholeskyDecomposition checkDecomp(Tensor matrix) {
    ...
    Tensor res = choleskyDecomposition.getL().dot(Pmul.of(choleskyDecomposition.diagonal(), ConjugateTranspose.of(choleskyDecomposition.getL())));
  ...
  public void testQuantity2() {
    ...
    }
    {
      ...
      Tensor upper = Pmul.of(Sqrt.of(cd.diagonal()), ConjugateTranspose.of(cd.getL()));
  ...
  private static Tensor rows_pmul_v(Tensor L, Tensor diag) {
    return TensorMap.of(row -> Pmul.of(row, diag), L, 1); // apply pmul on level 1
  }
  ...
  public void testQuantityComplex() {
    ...
    Tensor upper = Pmul.of(sdiag, ConjugateTranspose.of(cd.getL()));
    {
