...
class TimeSeriesTest {
  ...
  void testPath() {
    ...
    TimeSeries timeSeries = TimeSeries.of(p1, ResamplingMethods.INTERPOLATION_1);
  ...
  void testFails() {
    ...
    assertThrows(Exception.class, () -> TimeSeries.of(p1, ResamplingMethods.INTERPOLATION_1));
  }

  @Test
  void testNullFails() {
    assertThrows(Exception.class, () -> TimeSeries.of((Tensor) null, ResamplingMethods.INTERPOLATION_1));
    assertThrows(Exception.class, () -> TimeSeries.empty(null));
    Tensor p1 = Tensors.fromString("{{1, {1,1}}, {4, {3,2}}}").unmodifiable();
    TimeSeries.of(p1, ResamplingMethods.INTERPOLATION_1);
