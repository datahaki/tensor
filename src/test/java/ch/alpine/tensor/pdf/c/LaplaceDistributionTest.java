...
class LaplaceDistributionTest {
  ...
  void testQuantity() {
    ...
    assertEquals(ud.support(), Clips.positive(Quantity.of(Double.POSITIVE_INFINITY, "kg")));
  }
  ...
  void testComplexFail() {
    assertThrows(ClassCastException.class, () -> LaplaceDistribution.of(Complex.of(1, 2), RealScalar.ONE));
  }
