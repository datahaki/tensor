...
class InterpolationTest {
  @Test
  void test() {
    Tensor row1 = Tensors.of(DateTime.of(1980, Month.APRIL, 1, 12, 30), Pi.VALUE, Rational.HALF);
    Tensor row2 = Tensors.of(DateTime.of(2020, Month.JANUARY, 19, 18, 3), Pi.TWO, Rational.of(3, 2));
    Tensor row3 = Tensors.of(DateTime.of(1990, Month.DECEMBER, 24, 0, 0), RealScalar.ZERO, Rational.of(7, 2));
    ...
    {
      Tensor tensor = interpolation.at(Rational.HALF);
