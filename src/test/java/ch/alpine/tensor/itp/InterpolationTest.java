...
class InterpolationTest {
  @Test
  void test() {
    Tensor row1 = Tensors.of(DateObject.of(1980, Month.APRIL, 1, 12, 30), Pi.VALUE, RationalScalar.HALF);
    Tensor row2 = Tensors.of(DateObject.now(), Pi.TWO, RationalScalar.of(3, 2));
    Tensor row3 = Tensors.of(DateObject.of(1990, Month.DECEMBER, 24, 0, 0), RealScalar.ZERO, RationalScalar.of(7, 2));
