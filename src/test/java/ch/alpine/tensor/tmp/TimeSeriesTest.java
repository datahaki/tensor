...
class TimeSeriesTest {
  ...
  void testPath() {
    ...
    TimeSeries timeSeries = TimeSeries.of(p1, ResamplingMethods.LINEAR_INTERPOLATION);
  ...
  void testFails() {
    ...
    assertThrows(Exception.class, () -> TimeSeries.of(p1, ResamplingMethods.LINEAR_INTERPOLATION));
  }

  @Test
  void testNullFails() {
    assertThrows(Exception.class, () -> TimeSeries.of((Tensor) null, ResamplingMethods.LINEAR_INTERPOLATION));
