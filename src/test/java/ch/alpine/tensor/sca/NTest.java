...
class NTest {
  @Test
  void testZero() {
    Scalar result = N.DOUBLE.apply(RealScalar.ZERO);
  ...
  @Test
  void testDoubleId() {
    assertInstanceOf(DoubleScalar.class, N.DOUBLE.apply(RealScalar.of(3.14)));
    assertInstanceOf(DoubleScalar.class, N.DECIMAL32.apply(RealScalar.of(3.14)));
  }

  @Test
  void testContext() {
    Scalar d = N.DECIMAL128.apply(RealScalar.of(3).reciprocal());
