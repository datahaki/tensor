...
class RampTest {
  ...
  @Test
  void testInfty() {
    assertEquals(Ramp.FUNCTION.apply(DoubleScalar.POSITIVE_INFINITY), DoubleScalar.POSITIVE_INFINITY);
  }
  ...
  void testQuantity() {
    ...
    assertEquals(Ramp.FUNCTION.apply(qs1), qs1);
    assertEquals(Ramp.FUNCTION.apply(qs2), qs1.zero());
  }
