...
public class Norm2Test extends TestCase {
  public void testScalar() {
    assertEquals(Norm._2.ofVector(Tensors.fromString("{0}")), RealScalar.ZERO);
    assertEquals(Norm._2.ofVector(Tensors.fromString("{-3.90512}")), Scalars.fromString("3.90512"));
    assertEquals(Norm._2.ofVector(Tensors.fromString("{-3/7}")), Scalars.fromString("3/7"));
    Scalar rs = Norm._2.ofVector(Tensors.of(ComplexScalar.of(RealScalar.ONE, RealScalar.of(2)))); // <- sqrt(5)
  ...
  public void testVector1() {
    ...
    assertEquals(Norm._2.ofVector(A), Scalars.fromString("3.905124837953327"));
  }

  public void testVector2() {
    Tensor A = Tensors.of(ComplexScalar.of( //
        RealScalar.ONE, RealScalar.of(2)), DoubleScalar.of(1.5));
    assertEquals(Norm._2.ofVector(A), Scalars.fromString("2.6925824035672523"));
  ...
  public void testVector3() {
    ...
    assertEquals(Norm._2.ofVector(A), DoubleScalar.of(2.6925824035672523)); // 2.69258
  }
  ...
  public void testQuantity() {
    ...
    assertEquals(Norm._2.ofVector(vec), Quantity.of(5, "m^2"));
  }

  public void testQuantityMixed() {
    Tensor vec = Tensors.fromString("{0[m^2], 0[s*rad], 1}");
    assertEquals(Norm._2.ofVector(vec), RealScalar.ONE);
  }

  public void testMatrix2() {
    Tensor matrix = Tensors.fromString("{{}}");
    AssertFail.of(() -> Norm._2.ofMatrix(matrix));
  }
