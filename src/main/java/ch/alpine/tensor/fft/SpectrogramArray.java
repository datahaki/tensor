...
public enum SpectrogramArray {
  ...
  public static Tensor of(Tensor vector, ScalarUnaryOperator window) {
    return XtrogramArray.SPECTRO.of(vector, window);
  }
  ...
  public static Tensor of(Tensor vector) {
    return XtrogramArray.SPECTRO.of(vector);
  }
  ...
  public static Tensor half_abs(Tensor vector, ScalarUnaryOperator window) {
    return XtrogramArray.SPECTRO.half_abs(vector, window);
  }
  ...
  public static TensorUnaryOperator of(int windowLength, int offset, ScalarUnaryOperator window) {
    return XtrogramArray.SPECTRO.of(windowLength, offset, window);
  }
  ...
  public static TensorUnaryOperator of(int windowLength, int offset) {
    return XtrogramArray.SPECTRO.of(windowLength, offset);
  }
  ...
  public static TensorUnaryOperator of( //
    ...
    return XtrogramArray.SPECTRO.of(windowDuration, samplingFrequency, offset, window);
  }
  ...
  public static TensorUnaryOperator of( //
    ...
    return XtrogramArray.SPECTRO.of(windowDuration, samplingFrequency, window);
  }
}
