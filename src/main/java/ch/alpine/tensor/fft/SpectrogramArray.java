...
public enum SpectrogramArray {
  ...
  public static Tensor of(Tensor vector) {
    return XtrogramArray.Spectrogram.of(vector);
  }
  ...
  public static Tensor half_abs(Tensor vector, ScalarUnaryOperator window) {
    return XtrogramArray.Spectrogram.half_abs(vector, window);
  }
  ...
  public static TensorUnaryOperator of(int windowLength, int offset, ScalarUnaryOperator window) {
    return XtrogramArray.Spectrogram.of(windowLength, offset, window);
  }
  ...
  public static TensorUnaryOperator of(int windowLength, int offset) {
    return XtrogramArray.Spectrogram.of(windowLength, offset);
  }
  ...
  public static TensorUnaryOperator of( //
    ...
    return XtrogramArray.Spectrogram.of(windowDuration, samplingFrequency, offset, window);
  }
  ...
  public static TensorUnaryOperator of( //
    ...
    return XtrogramArray.Spectrogram.of(windowDuration, samplingFrequency, window);
  }
}
