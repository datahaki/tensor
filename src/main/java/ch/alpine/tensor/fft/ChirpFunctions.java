...
public enum ChirpFunctions {
  LINEAR {
    @Override
    public ScalarUnaryOperator of(Scalar f0, Scalar k) {
  ...
  EXPONENTIAL {
    @Override
    public ScalarUnaryOperator of(Scalar f0, Scalar alpha) {
  ...
  public abstract ScalarUnaryOperator of(Scalar f0, Scalar p1);

  public ScalarUnaryOperator of(Number f0, Number p1) {
    return of(RealScalar.of(f0), RealScalar.of(p1));
  }
}
