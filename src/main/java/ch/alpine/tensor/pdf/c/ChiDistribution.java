...
class ChiDistribution extends GammaDistribution {
  ...
  public Scalar randomVariate(RandomGenerator randomGenerator) {
    return Vector2Norm.of(RandomVariate.of(NormalDistribution.standard(), randomGenerator, n));
  }

  @Override // from Object
  public String toString() {
    return MathematicaFormat.concise("ChiDistribution", n);
  }
}
