...
/* package */ class BchSeries8 extends BchSeries {
  ...
  private static final Scalar P1_30240 = Rational.of(1, 30240);
  private static final Scalar P1_6720 = Rational.of(1, 6720);
  private static final Scalar N1_15120 = Rational.of(-1, 15120);
  private static final Scalar N1_10080 = Rational.of(-1, 10080);
  private static final Scalar P1_10080 = Rational.of(1, 10080);
  private static final Scalar N1_20160 = Rational.of(-1, 20160);
  private static final Scalar P1_4032 = Rational.of(1, 4032);
  private static final Scalar P1_1260 = Rational.of(1, 1260);
  private static final Scalar P1_3360 = Rational.of(1, 3360);
  private static final Scalar N1_7560 = Rational.of(-1, 7560);
  private static final Scalar N1_1890 = Rational.of(-1, 1890);
  private static final Scalar N1_672 = Rational.of(-1, 672);
  private static final Scalar N1_3150 = Rational.of(-1, 3150);
  private static final Scalar P1_6048 = Rational.of(1, 6048);
  private static final Scalar P1_1680 = Rational.of(1, 1680);
  private static final Scalar P1_4200 = Rational.of(1, 4200);
  private static final Scalar N1_6048 = Rational.of(-1, 6048);
  private static final Scalar N11_50400 = Rational.of(-11, 50400);
  private static final Scalar N1_30240 = Rational.of(-1, 30240);
  private static final Scalar P1_13440 = Rational.of(1, 13440);
  private static final Scalar P1_12096 = Rational.of(1, 12096);
  private static final Scalar N1_3360 = Rational.of(-1, 3360);
  private static final Scalar N1_12096 = Rational.of(-1, 12096);
  private static final Scalar P1_8064 = Rational.of(1, 8064);
  private static final Scalar P1_2520 = Rational.of(1, 2520);
  private static final Scalar P1_20160 = Rational.of(1, 20160);
  private static final Scalar N1_3780 = Rational.of(-1, 3780);
  private static final Scalar N1_1344 = Rational.of(-1, 1344);
  private static final Scalar N1_6300 = Rational.of(-1, 6300);
  private static final Scalar P1_8400 = Rational.of(1, 8400);
  private static final Scalar N11_100800 = Rational.of(-11, 100800);
  private static final Scalar N1_60480 = Rational.of(-1, 60480);
