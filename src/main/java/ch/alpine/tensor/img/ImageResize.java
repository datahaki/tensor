...
public enum ImageResize {
  ...
  public BufferedImage of(BufferedImage bufferedImage, int width, int height) {
    AffineTransform affineTransform = AffineTransform.getScaleInstance( //
        width / (double) bufferedImage.getWidth(), //
        height / (double) bufferedImage.getHeight());
    return new AffineTransformOp(affineTransform, affineTransformType()).filter( //
        bufferedImage, //
   ...
   * @return */
  public Tensor of(Tensor tensor, int height, int width) {
    return ImageFormat.from(of(ImageFormat.of(tensor), width, height));
  }
  ...
  public Tensor of(Tensor tensor, Scalar factor) {
