...
class Rapoly extends MultiplexScalar {
  ...
  public Scalar multiply(Scalar scalar) {
    if (scalar instanceof Rapoly) {
      Rapoly rapoly = (Rapoly) scalar;
      return new Rapoly(polynomial.times(rapoly.polynomial));
    }
    return new Rapoly(polynomial.times(scalar));
  }
  ...
  protected Scalar plus(Scalar scalar) {
    return scalar instanceof Rapoly //
        ? new Rapoly(polynomial.plus(((Rapoly) scalar).polynomial))
  ...
  public boolean equals(Object object) {
    return object instanceof Rapoly //
        && polynomial.equals(((Rapoly) object).polynomial);
  }
