...
public class DateObject extends AbstractScalar implements //
  ...
  public Scalar subtract(Tensor tensor) {
    if (tensor instanceof DateObject) {
      DateObject dateObject = (DateObject) tensor;
  ...
  public int compareTo(Scalar scalar) {
    if (scalar instanceof DateObject) {
      DateObject dateObject = (DateObject) scalar;
  ...
  public boolean equals(Object object) {
    return object instanceof DateObject //
        && localDateTime.equals(((DateObject) object).localDateTime);
  }
